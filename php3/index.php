...
<body>
  ...
  echo "<br> date('D/M/Y H:i:s') " . date("D/M/Y H:i:s");
  echo "<br> date('D/M/Y')" . date("30/04/96");
  echo "<br> date ('D/M/Y h:i:s') " . date("15/03/1996 2:23:52") ;
  ?>
   <pre>
     ...
     hàm time() láy ra thời gian hiện tại nhưng ở dạng timestamp
      </pre>
          <?php echo "<br> time() " . time(); ?>
          <pre>
              vấn đề 1 : chuyển định dạng thời gian timestamp về kiểu
              định dạng thời gian đọc được
              giải quyết : date('fomet',timestamp)
           </pre>
            <?php echo "<br> tie ()" . time (); ?>
           </pre>
               vấn đề 1 : chuyển định dạng thời gian timestamp vẽ kiểu
               định dạng thời gian đọc được
