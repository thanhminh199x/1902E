...
<head>
    ...
    <title>Shoppy E commerce Admin Panel Responsive Web Template</title>
    <!-- BOOTSTRAP STYLES-->
        ...
        <div class="adjust-nav">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img src="{{ asset("https://w3layouts.b-cdn.net/wp-content/themes/w3layouts/images/w3layouts_White_text_near_big.png") }}" />
            ...
            <span class="logout-spn" >
                  <a href="#" style="color:#fff;">My Account</a>
